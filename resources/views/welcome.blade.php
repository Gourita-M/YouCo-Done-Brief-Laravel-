    ...
    <div class="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <div class="mt-8 flex gap-4">
          <button class="bg-orange-500 text-white px-6 py-3 rounded-xl font-medium hover:bg-orange-600">Explore Restaurants</button>
          <button class="border border-orange-500 text-orange-500 px-6 py-3 rounded-xl font-medium hover:bg-orange-50">List Your Restaurant</button>
        </div>
      </div>
